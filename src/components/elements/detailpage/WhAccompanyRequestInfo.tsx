    ...
    <div className='w-[393px]'>
      ...
      <div className='max-h-[412px] overflow-scroll'>
        {detailList.itemList.map((accompany) => (
          ...
          >
            <div className={`flex gap-5 border-b border-b-nutral-white-03 px-3 pb-5 ${accompany.status !== 'joining' && accompany.status !== 'joined' ? `opacity-70`: 'null'} `} >
              <Image
                ...
                {isHost ? (
                  ...
                  <>
                    <div  >
                      {accompany.status === 'joining' && (
                        <div className='flex gap-[10px] mt-3'>
                          ...
                          <WhButton fitContent size='sm' onClick={onOpen}>
                            승인
                          </WhButton>
                        </div>
                      )}
                    ...
                    <WhModal
                     ...
                     >
                      <WhModalHeader>
                        {accompany.nickname}님의 동행을 승인할까요?
                      </WhModalHeader>
