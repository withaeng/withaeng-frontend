  ...
  return createPortal(
    ...
    >
      <div ref={nodeRef}>
        ...
        />
        <div className='modal-content absolute max-xl:bottom-0 w-full xl:top-1/2 xl:left-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2 bg-nutral-white-01 z-50 xl:w-fit rounded-t-[20px] xl:rounded shadow-modal'>
