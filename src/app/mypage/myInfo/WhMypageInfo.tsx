      ...
      <div className='flex flex-col'>
        <div className='flex gap-[60px]'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <ul className='flex  bg-nutral-white-02 py-5 px-4 gap-6 text-center rounded'>
              <li className='flex flex-col border-r border-nutral-white-03 pr-6'>
                <p className='text-subtitle-01 mb-2'>{itemList.score}</p>
                <span className='text-nutral-black-03 text-body-03'>
                  매너점수
                </span>
              </li>
              <li className='border-r border-nutral-white-03 pr-6'>
                <p className='text-subtitle-01 mb-2'>{itemList.review}</p>
                <span className='text-nutral-black-03 text-body-03'>후기</span>
              </li>
              <li>
                <p className='text-subtitle-01 mb-2'>{itemList.period}</p>
                <span className='text-nutral-black-03 text-body-03'>
                  접속 기간
                </span>
              </li>
