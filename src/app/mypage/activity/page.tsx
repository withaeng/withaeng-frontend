  ...
  return (
    <div className='mb-10 flex flex-col gap-10'>
      ...
      <WhMypageCard title='매너 점수 & 나의 배지'>
        ...
        <section className='bg-nutral-white-02 px-4 py-2 xl:py-[3.75rem] xl:px-[4.375rem] rounded overflow-scroll grid grid-cols-3 gap-1 xl:gap-12'>
          {badgeList.map((item) => (
            <div
            ...
            >
              ...
              <span className='xl:text-subtitle-01 text-subtitle-02 text-nutral-black-02'>
                {item.value}
              </span>
            </div>
          ))}
